            ...
            <div class="col-lg-12">
                <section class="card bg-dark text-light">
                    ...
                    <div class="card-body bg-secondary text-light">
                        <form class="needs-validation" action="{{ route('banner.update' , $banner->id) }}" method="POST" enctype="multipart/form-data" autocomplete="off" id="bannerForm">
                            @csrf
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    <label for="validationCustom01">Banner Title:</label>
                                    <input type="text" class="form-control bg-dark text-light @error('title') is-invalid @enderror" id="validationCustom01" placeholder="Enter Banner Title" name="title" value="{{$banner->title}}">
                                    @error('title')
